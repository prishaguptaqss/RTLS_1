...
logging.basicConfig(
    ...
    format=log_format,
    handlers=[
        logging.FileHandler('/home/qss/Documents/common/RTLS_1/logs/server.log'),
...
org_handler = logging.FileHandler('/home/qss/Documents/common/RTLS_1/logs/organization_isolation.log')
